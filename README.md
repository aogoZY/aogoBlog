...
![image-20211105083312329](/Users/zhouyang/Library/Application Support/typora-user-images/image-20211105083312329.png)
...
### 2、ERROR 2003 (HY000): Can't connect to MySQL server on '127.0.0.1:3306' (61)

每次关机数据库都会挂掉。因为我是用docker起的。
...
### 3、idea安装mybatis插件 可以从IDao跳转至对应的xml文件

idea设置 plugins搜索**Free MyBatis plugin安装**并重启idea

![image-20211123082747410](/Users/zhouyang/Library/Application Support/typora-user-images/image-20211123082747410.png)
...
https://www.wdhhh.cn/traffic。 带流量pv的统计图